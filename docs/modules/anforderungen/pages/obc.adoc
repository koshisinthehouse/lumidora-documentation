...
:navtitle: Organisatorische Randbedingungen
...
In diesem Abschnitt geht es um die Organisatorischen Randbedingunen, welch für die Anwendung ai-assistant gelten.
